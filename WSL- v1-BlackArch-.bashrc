...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@WSL-BlackArch\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
###############################################################################################################
# <-=[- WSL v1 BlackArch Linux -]=->		          # Default Aliases                                 		      #
###############################################################################################################
...
###############################################################################################################
# <-=[- WSL v1 BlackArch Linux -]=->              # Crucial Add-on Aliases				                            #
###############################################################################################################
...
alias gitcommit='cd /home/ninjitsu/GitHub/ninjitsu;
                 git init;
	               git add .;
                 git commit -m "Latest Auto-Commit < [ WSL v1 BlackArch Linux ] > .bashrc"'
...
# Copy latest .bashrc to the current directory saved as WSL-v1-BlackArch-.bashrc										          #
alias cpbashrc='sudo cp /home/ninjitsu/.bashrc /home/ninjitsu/GitHub/ninjitsu/WSL-v1-BlackArch-.bashrc;'
# Copy latest .bashrc to GitHub all-in-one                                                                    #
alias b2rr='sudo cp /home/ninjitsu/.bashrc /home/ninjitsu/GitHub/ninjitsu/WSL-v1-BlackArch.bashrc;
            ...
            git pull https://github.com/relativerefractions/ninjitsu.git;
            git push -u origin master;'
# Copy WSL v1 BlackArch .bashrc to .bashrc                                                                    #
alias rr2b='sudo cp /home/ninjitsu/.bashrc /home/ninjitsu/GitHub/ninjitsu/WSL-v1-BlackArch.bashrc;'
